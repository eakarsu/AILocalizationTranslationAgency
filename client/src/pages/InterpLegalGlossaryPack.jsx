...
const ENDPOINT = '/interp/legal-glossary-pack';
const TITLE = 'Legal Glossary Pack';

const FIELDS = [
  { name: 'pack_name', label: 'Pack Name', type: 'text' },
  ...
  { name: 'legal_domain', label: 'Legal Domain', type: 'text' },
  { name: 'status', label: 'Status', type: 'select', options: ['draft', 'active', 'deprecated', 'review'] },
  { name: 'term_count', label: 'Term Count', type: 'number' },
...
const AI_VERBS = [
  ...
  'suggest-equivalent-legal-terms',
  'classify-legal-document-type',
  'check-regulatory-alignment',
  'flag-ambiguous-clauses',
  'score-legal-accuracy',
  'detect-outdated-statutes',
  'generate-term-definitions',
  'cross-reference-case-law',
  'assess-translation-risk',
  'recommend-plain-language-alternatives',
  'detect-latin-phrases',
  'suggest-jurisdiction-specific-terms',
  'prioritize-high-risk-terms',
  'generate-glossary-summary',
];
...
export default function InterpLegalGlossaryPack() {
    ...
    <div>
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: 8 }}>
          ...
          <button className="btn btn-primary" style={{ width: 'auto' }} onClick={openNew}>+ New Pack</button>
        </div>
      </div>
