...
const ENDPOINT = '/interp/streaming-mt';
const TITLE = 'Streaming MT';
...
const FIELDS = [
  ...
  { name: 'mt_engine', label: 'MT Engine', type: 'text' },
  ...
  { name: 'token_count', label: 'Token Count', type: 'number' },
];
...
const AI_VERBS = [
  ...
  'suggest-post-edit-improvements',
  'score-fluency',
  'score-adequacy',
  'detect-terminology-errors',
  'predict-human-review-need',
...
export default function InterpStreamingMt() {
