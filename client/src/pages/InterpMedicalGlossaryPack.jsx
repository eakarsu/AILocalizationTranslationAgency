...
const ENDPOINT = '/interp/medical-glossary-pack';
const TITLE = 'Medical Glossary Pack';
...
const FIELDS = [
  ...
  { name: 'regulatory_standard', label: 'Regulatory Standard', type: 'text' },
...
const AI_VERBS = [
  ...
  'detect-outdated-terms',
  'recommend-equivalent-terms',
  'assess-translation-accuracy',
  'flag-ambiguous-terms',
  'suggest-standardization',
  'generate-usage-examples',
  'cross-reference-icd-codes',
  'detect-dosage-terms',
...
export default function InterpMedicalGlossaryPack() {
