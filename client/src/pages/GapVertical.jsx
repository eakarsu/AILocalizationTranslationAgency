...
// Vertical
// Vertical TM management (legal/medical/technical) leveraged across clients
...
export default function GapVertical() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vertical TM management (legal/medical/technical) leveraged across clients</p>
