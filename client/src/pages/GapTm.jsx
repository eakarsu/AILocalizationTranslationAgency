...
// Tm
// TM synchronization & leverage metrics dashboard

export default function GapTm() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-tm', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Tm</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>TM synchronization & leverage metrics dashboard</p>
