...
// Streaming
// Streaming QA agent reviewing translation against glossary + tone in real time
...
export default function GapStreaming() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Streaming QA agent reviewing translation against glossary + tone in real time</p>
