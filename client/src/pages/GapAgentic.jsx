...
// Agentic
// Agentic translator assignment matching expertise to language pair + subject matter
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic translator assignment matching expertise to language pair + subject matter</p>
