...
// Multi Modal
// Multi-modal pipeline: text + image OCR + subtitles + audio in single workflow
...
export default function GapMultiModal() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Multi-modal pipeline: text + image OCR + subtitles + audio in single workflow</p>
