...
// Dtp
// DTP integration (InDesign, Figma, XML/HTML preservation)

export default function GapDtp() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-dtp', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Dtp</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>DTP integration (InDesign, Figma, XML/HTML preservation)</p>
