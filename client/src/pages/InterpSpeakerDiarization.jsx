...
const ENDPOINT = '/interp/speaker-diarization';
const TITLE = 'Speaker Diarization';
...
const FIELDS = [
  ...
  { name: 'speaker_count', label: 'Speaker Count', type: 'number' },
  { name: 'status', label: 'Status', type: 'select', options: ['active', 'processing', 'completed', 'error'] },
  { name: 'min_speakers', label: 'Min Speakers', type: 'number' },
  { name: 'max_speakers', label: 'Max Speakers', type: 'number' },
  { name: 'diarization_model', label: 'Diarization Model', type: 'text' },
...
const AI_VERBS = [
  ...
  'score-diarization-accuracy',
  'recommend-diarization-model',
  'flag-ambiguous-segments',
  'generate-speaker-summary',
  'detect-gender-distribution',
  'estimate-speaker-talk-time',
  'detect-interruptions',
  'classify-conversation-type',
  'recommend-min-max-speakers',
  'detect-noise-between-speakers',
  'generate-diarization-report',
];
...
export default function InterpSpeakerDiarization() {
