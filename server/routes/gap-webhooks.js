...
// Feature: Webhooks
// Description: Webhooks for CAT-tool integration (Trados, MemoQ)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Webhooks. Webhooks for CAT-tool integration (Trados, MemoQ)' },
