...
// Domain: brand voice consistency agent — Capability: enforcing brand voice across client projects
...
router.post('/run', async (req, res) => {
  try {
    ...
    const systemPrompt = 'You are a brand voice consistency agent. Your task is enforcing brand voice across client projects. Respond with concise JSON: { "summary": string, "recommendations": string[], "next_actions": string[], "confidence": number }.';
